...
DROP POLICY IF EXISTS "Users can CRUD own watchlists" ON watchlists;
CREATE POLICY "Users can CRUD own watchlists" ON watchlists FOR ALL USING (auth.uid() = user_id);

ALTER TABLE public.watchlist_items ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Users can CRUD own watchlist items" ON watchlist_items;
...
DROP POLICY IF EXISTS "Users can manage own email prefs" ON email_preferences;
